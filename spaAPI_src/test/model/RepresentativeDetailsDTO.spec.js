...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.RepresentativeDetailsDTO();
  });
  ...
  describe('RepresentativeDetailsDTO', function() {
    it('should create an instance of RepresentativeDetailsDTO', function() {
      // uncomment below and update the code to test RepresentativeDetailsDTO
      //var instance = new OpenApiDefinition.RepresentativeDetailsDTO();
      //expect(instance).to.be.a(OpenApiDefinition.RepresentativeDetailsDTO);
    });
